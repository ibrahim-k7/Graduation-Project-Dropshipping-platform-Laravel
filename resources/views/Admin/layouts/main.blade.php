...
<<<<<<< HEAD
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#tables-nav" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-layout-text-window-reverse"></i><span>Delivery</span><i
                        class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="{{ Route('admin.delivery') }}">
                            <i class="bi bi-circle"></i><span>Delivery Management</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ Route('admin.delivery.insert') }}">
                            <i class="bi bi-circle"></i><span>Insert New Delivery </span>
                        </a>
                    </li>
