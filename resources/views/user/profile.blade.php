                ...
                <div class="card" style="margin-top: 50px">
                    <div class="card-body" style="margin-top: 50px">
                        ...
                        <ul class="nav nav-tabs" id="myTabs">
                            <li class="nav-item">
                                <a class="nav-link active" id="userInfo-tab" data-bs-toggle="tab" href="#userInfo">بيانات
                                    المستخدم</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="updateEmailForm-tab" data-bs-toggle="tab"
                                    href="#updateEmailForm">تحديث الايميل</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="updatePasswordForm-tab" data-bs-toggle="tab"
                                    href="#updatePasswordForm">تحديث كلمة السر</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="tab-content mt-2">
                            ...
                            <div class="tab-pane fade" id="updatePasswordForm">
                                <form method="POST" action="{{ route('user.profile.updatePassword') }}">
                                    ...
                                    <div class="mb-3">
                                        <label for="password_confirmation" class="form-label">تأكيد كلمة السر
                                            الجديدة</label>
                            ...
                            <div class="tab-pane fade" id="updatePhoneNumberForm">
                                <form method="POST" action="{{ route('user.profile.updatePhoneNumber') }}">
                                    @csrf
                                    <div class="mb-3">
